...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-info shadow-sm py-2">
            <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>Chào 
                                    {{ Auth::user()->name }}
                                </a>
